...
"""Performance Max tools for the Google Ads MCP server (BetterMe extension).
...
def campaign_create(
    ...
    creation (recommended for BetterMe web funnels). NOTE: the campaign is
...
def asset_group_set_all_products(
    ...
    For BetterMe subscription products this is normally NOT needed — only
